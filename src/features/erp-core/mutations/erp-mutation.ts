// oz-next-app/src/features/erp-core/mutations/erp-mutation.ts
"use client";

import type { QueryClient, QueryFilters } from "@tanstack/react-query";

import type { QuerySerializable } from "@/lib/query/index";

import type { ErpActorScope } from "@/features/erp-core/contracts/erp-common.schema";
import { erpFeatureQueryKeys } from "@/features/erp-core/queries/erp-query-keys";

// oz-next-app/src/features/auth/ui/login-client.tsx
"use client";
...
import type { LoginStartResult } from "@/features/auth/contracts/auth-form.schema";
import {
  loginNoticeFromReason,
  safeNextPath,
} from "@/features/auth/utils/auth-redirect";
import { maskIdentifier } from "@/features/auth/utils/mask-identifier";
import { LoginBrandMark } from "@/features/auth/ui/login-brand-mark";
import { LoginStartForm } from "@/features/auth/ui/login-start-form";
import { OtpVerifyForm } from "@/features/auth/ui/otp-verify-form";
import { SessionExpiredCard } from "@/features/auth/ui/session-expired-card";

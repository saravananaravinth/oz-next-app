...
export function PublicWarrantyShell({
  ...
  return (
    <div className="relative isolate flex min-h-svh min-w-0 flex-col bg-background text-foreground">
      ...
      <aside
        aria-label="Warranty privacy and document safety"
      ...
      >
        <div className="mx-auto flex max-w-3xl items-start justify-center gap-2.5">
          ...
          <p className="max-w-2xl text-left text-caption leading-relaxed text-muted-readable text-pretty sm:text-center">
            ...
            Invoice files are accepted only for this warranty request and are
            not published through a public CDN. Never upload OTPs, passwords,
            payment credentials, Aadhaar, PAN, or unrelated identity documents.
          </p>
        </div>
      </aside>

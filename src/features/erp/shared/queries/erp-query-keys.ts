// oz-next-app/src/features/erp/shared/queries/erp-query-keys.ts
import { stableQueryValue, type QuerySerializable } from "@/lib/query";

import type { ErpActorScope } from "../schemas/erp-common.schema";
import { erpActorScopeKeyInput } from "./erp-query-scope";

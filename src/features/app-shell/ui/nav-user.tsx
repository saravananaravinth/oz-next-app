// oz-next-app/src/features/app-shell/ui/nav-user.tsx
"use client";
...
import type { AuthInfo } from "@/features/app-shell/ui/app-sidebar";
import {
  cleanDisplayText,
  formatRoleLabel,
...
import { safeImageSrc } from "@/lib/security/navigation";

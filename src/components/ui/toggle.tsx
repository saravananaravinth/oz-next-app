  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        outline:
          "border-input bg-background shadow-xs hover:bg-muted dark:bg-input/30 dark:hover:bg-input/50",
      },
      size: {
        default:
          "h-10 min-w-10 px-3 has-data-[icon=inline-end]:pe-2.5 has-data-[icon=inline-start]:ps-2.5",
        sm: "h-8 min-w-8 rounded-xl px-2.5 text-caption has-data-[icon=inline-end]:pe-2 has-data-[icon=inline-start]:ps-2 [&_svg:not([class*='size-'])]:size-3.5",

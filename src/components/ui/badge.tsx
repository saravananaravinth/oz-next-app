...
const badgeVariants = cva(
  [
    ...
    "transition-[background-color,border-color,color,box-shadow,opacity] duration-[var(--motion-duration-fast)] ease-enterprise motion-reduce:transition-none",
  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        success:
          "border-success/25 bg-success/10 text-success focus-visible:ring-success/25 [a]:hover:bg-success/15 dark:bg-success/15",
        warning:
        ...
        info: "border-info/25 bg-info/10 text-info focus-visible:ring-info/25 [a]:hover:bg-info/15 dark:bg-info/15",
        outline:

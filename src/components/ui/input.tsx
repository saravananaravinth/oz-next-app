...
const INPUT_CLASS_NAME = [
  ...
  "file:me-3 file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-caption file:[font-weight:var(--typography-emphasis-weight)] file:text-foreground",

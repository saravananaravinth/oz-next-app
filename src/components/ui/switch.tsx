...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "peer group/switch relative inline-flex shrink-0 items-center rounded-full border border-transparent outline-none after:absolute after:-inset-x-3 after:-inset-y-2 transition-[background-color,border-color,box-shadow] duration-[var(--motion-duration-fast)] ease-enterprise motion-reduce:transition-none",
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block rounded-full bg-background shadow-sm ring-0 transition-transform duration-[var(--motion-duration-fast)] ease-enterprise motion-reduce:transition-none group-data-[size=default]/switch:size-4 group-data-[size=sm]/switch:size-3 group-data-[size=default]/switch:data-[state=checked]:translate-x-4 group-data-[size=default]/switch:data-checked:translate-x-4 group-data-[size=sm]/switch:data-[state=checked]:translate-x-3 group-data-[size=sm]/switch:data-checked:translate-x-3 rtl:group-data-[size=default]/switch:data-[state=checked]:-translate-x-4 rtl:group-data-[size=default]/switch:data-checked:-translate-x-4 rtl:group-data-[size=sm]/switch:data-[state=checked]:-translate-x-3 rtl:group-data-[size=sm]/switch:data-checked:-translate-x-3 group-data-[size=default]/switch:data-[state=unchecked]:translate-x-0 group-data-[size=default]/switch:data-unchecked:translate-x-0 group-data-[size=sm]/switch:data-[state=unchecked]:translate-x-0 group-data-[size=sm]/switch:data-unchecked:translate-x-0 dark:data-[state=checked]:bg-primary-foreground dark:data-checked:bg-primary-foreground dark:data-[state=unchecked]:bg-foreground dark:data-unchecked:bg-foreground"
      />
    </SwitchPrimitive.Root>
  );
}

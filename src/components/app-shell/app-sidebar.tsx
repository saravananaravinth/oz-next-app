// oz-next-app/src/components/app-shell/app-sidebar.tsx
"use client";
...
import { NavMain, type Item as NavItem } from "@/components/app-shell/nav-main";
...
import { safeAssetPath, safeInternalHref } from "@/lib/security";

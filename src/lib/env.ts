...
const publicUrlSchema = z.string().trim().pipe(z.url());

const envSchema = z
  .object({
    NEXT_PUBLIC_API_BASE_URL: publicUrlSchema.default(
      "https://api.ozotecev.com",
    ),
    ...
    NEXT_PUBLIC_APP_ORIGIN: publicUrlSchema.default("https://erp.ozotecev.com"),

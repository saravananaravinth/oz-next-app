...
export const ENGAGEMENT_ENDPOINTS = {
  ...
  operationsDashboardJourneySummary: `${ERP_PREFIX}/engagement/dashboard/journey/summary`,
  operationsDashboardJourneyFunnel: `${ERP_PREFIX}/engagement/dashboard/journey/funnel`,
